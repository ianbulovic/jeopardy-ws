...
window.addEventListener("DOMContentLoaded", () => {
  ...
  events.submitBetEvent = (event) => {
    ...
    playerRowMap[playerName].querySelector(".player-bet").textContent =
      betValue;
  };
  ...
  events.submitAnswerEvent = (event) => {
    ...
    playerRowMap[playerName].querySelector(".player-answer").textContent =
      answerValue;
  };
  ...
  events.scoreEvent = (event) => {
    ...
    playerRowMap[playerName].querySelector(".player-score").textContent =
      newScore;
  };
});
